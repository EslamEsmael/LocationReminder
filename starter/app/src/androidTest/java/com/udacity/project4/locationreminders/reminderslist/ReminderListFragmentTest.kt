...
class ReminderListFragmentTest {
    ...
    fun init() {
        ...
        repository = ProcessLifecycleOwner.get() as FakeDataSource
    ...
    fun listOfReminders_showListOfReminders() {
        ...
        val reminder = ReminderDTO("Go to portsaid", "",
        ...
        onView(withId(R.id.noDataTextView)).check(ViewAssertions.matches(Matchers.not(ViewMatchers.isDisplayed())))
